        ...
        <div class="box-body">
          <div class="box box-widget widget-user-2">
            <div class="widget-user-header ">
              ...
              <h5 class="widget-user-desc">Edit Price</h5>
              ...
              <div class="col-md-8" style ="margin-left: -2.6%;" >    
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input  type="hidden" class="form-control" name="id_price" id="edit_price"  value="<?= $amuco_details_requests_price_edit[0]->id ?>" >
                  </div>
                </div>
              </div>
              <div class="col-md-2">  </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5" >                                       
                    <div class="form-group ">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control input-element" name="price_fob" id="price_fob" placeholder="Price" value="<?= $amuco_details_requests_price_edit[0]->price_fob ?>">
                        </div>
                    </div>
                </div>  
                <div class="col-md-5" >                                        
                    <div class="form-group ">
                        ...
                        <div class="col-sm-7">
                            <input type="text" <?= $amuco_details_customers_requests[0]->quantity < 1 ? 'disabled' : '' ; ?> class="form-control  input-element" name="total_freight" id="total_freight" placeholder="Freight" value=" <?= $amuco_details_requests_price_edit[0]->total_freight ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-1">  </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5" >                                       
                    <div class="form-group ">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control  input-element" name="total_price" id="total_price" placeholder="Price" value="<?= $amuco_details_requests_price_edit[0]->total_price ?>">
                        </div>
                    </div>
                </div>  
                <div class="col-md-5" >                                        
                    <div class="form-group ">
                        ...
                        <div class="col-sm-7">
                            <select  class="form-control chosen chosen-select-deselect" name="incoterm_price" id="incoterm_price"  >
                                ...
                                <option <?= $amuco_details_requests_price_edit[0]->incoterm_price ==  $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                <?php endforeach; ?>  
                            </select>
                        </div>    
                    </div>
            ...
            <div class="row"> 
                        ...
                        <div class="col-sm-7">
                            ...
                            <select  class="form-control chosen chosen-select-deselect" name="supplier_direct" id="supplier_direct" data-placeholder="Select Supplier" >
                                            ...
                                            <?php foreach (db_get_all_data('amuco_suppliers') as $row): ?>
                                                   ...
                                                   <option <?php echo $amuco_details_requests_price_edit[0]->supplier == $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                                 <?php   endforeach;?>  
                                        </select>
                        </div>    
                    </div>
                ...
                <div class="col-md-5" >                                       
                    <div class="form-group ">
                        <label for="weight" class="col-sm-4 label-right ">Supplier </label>
                        <input type="hidden" class="form-control" name="purchasing" id="purchasing" value="<?=  $amuco_details_requests_price_edit[0]->purchasing ?>">
                        <div class="col-sm-7">
            ...
            <?php   endif;?>   
                <div class="col-md-5" >                                        
                    <div class="form-group ">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="brand" id="brand" placeholder="Brand" value="<?= $amuco_details_requests_price_edit[0]->brand ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-1">  </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-7">
                      <select  class="form-control chosen chosen-select-deselect" name="manufacturer" id="manufacturer" data-placeholder="Select Manufacturer" >
                        <option value=""></option>
                        <?php foreach (db_get_all_data('amuco_suppliers') as $row): ?>
                              <option <?php echo $amuco_details_requests_price_edit[0]->manufacturer == $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                          <?php   endforeach;?>  
                      </select>
                    </div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-7">
                        <select  class="form-control chosen chosen-select-deselect" name="payment_terms" id="payment_terms" data-placeholder="Select Destination Port" >
                            ...
                            <option <?php echo $amuco_details_requests_price_edit[0]->payment_terms == $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->description; ?></option>
                            <?php endforeach; ?>  
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-5" >                                        
                  <div class="form-group ">
                      ...
                      <select  class="form-control chosen chosen-select-deselect" name="supplier_incoterm" id="supplier_incoterm"  >
                          <option value=""></option>
                          <?php foreach (db_get_all_data('amuco_incoterm') as $row): ?>
                          <option  <?php echo $amuco_details_requests_price_edit[0]->supplier_incoterm == $row->id ? 'selected' : '' ?>  value="<?= $row->id ?>"><?= $row->name; ?></option>
                          <?php endforeach; ?>  
                      </select>
                      </div>
                  </div>
                ...
                <div class="col-md-5" >                                       
                  <div class="form-group ">
                      ...
                      <select  class="form-control chosen chosen-select-deselect" name="shipping_port" id="shipping_port" data-placeholder="Select Shipping Port" >
                          ...
                          <option    <?php echo $amuco_details_requests_price_edit[0]->shipping_port == $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                          <?php endforeach; ?>  
                      </select>
                      </div>
                  </div>
            ...
            <div class="row"> 
              ...
              <div class="col-md-5" >                                       
                  <div class="form-group ">
                      ...
                      <select  class="form-control chosen chosen-select-deselect" name="destination_port" id="destination_port" data-placeholder="Select Destination Port" >
                          <option value=""></option>
                          <?php foreach (db_get_all_data('amuco_destination_port') as $row): ?>
                          <option <?php echo $amuco_details_requests_price_edit[0]->destination_port == $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                          <?php endforeach; ?>  
                      </select>
                      </div>
                  </div>
              ...
              <div class="col-md-5" >                                        
                <div class="form-group ">
                    <label for="weight" class="col-sm-4 label-right ">Delivery date </label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control pull-right datepicker" name="ETD"  placeholder="ETD Date" id="etd" value="<?php echo substr($amuco_details_requests_price_edit[0]->ETD,0,10);?>">
                    </div>
                </div>
              </div> 
              <div class="col-md-1">  </div>
            ...
            <div class="row"> 
                ...
                <div class="col-md-5" >                                       
                  <div class="form-group ">
                      ...
                      <div class="col-sm-7">
                      <input type="text" class="form-control pull-right datepicker" name="valid_until"  placeholder="Date " id="valid_until" value="<?php echo substr($amuco_details_requests_price_edit[0]->valid_until,0,10);?>">
                      </div>
                  </div>
                </div>   
                <div class="col-md-5" >                                        
                    <div class="form-group ">
                        ...
                        <div class="col-sm-7">
                            <input  type="text" class="form-control" name="analysis_standard" id="analysis_standard"  value="<?= $amuco_details_requests_price_edit[0]->analysis_standard ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-1">  </div>
            ...
            <div class="row"> 
              ...
              <div class="col-md-10" style="margin-left: -5%;">                                  
                <div class="form-group ">
                  ...
                  <div class="col-sm-7">
                    <textarea class="form-control" style="resize:none" id="comments" name="comments" rows="5" ><?= set_value('Specific Remarks', $amuco_details_requests_price_edit[0]->comments); ?></textarea>
         ...
         <hr>
          <div style="text-align: right;margin-right:2%">
            ...
            <button class="btn btn-flat btn-primary  btn_action btn-display" id="btn_save_price" data-stype='stay' title="<?= cclang('save_button'); ?>">
              <i class="fa fa-save" ></i> <?= cclang('Save'); ?>
            </button>
           
            <button  class="btn btn-flat btn-primary  btn_action " id="btn_edit_price" data-stype='stay' title="<?= cclang('save_button'); ?>">
