...
class Model_amuco_visits extends MY_Model {
    ...
    public $field_search   = ['id', 'type_visit', 'type_client', 'user_id', 'customer_id', 'supplier_id', 'date_visit', 'contact_name'];
    ...
    public function join_avaiable() {
        ...
        $this->db->select('amuco_visits.*,aauth_users.username as aauth_users_username,amuco_customers.name as amuco_customers_name,amuco_suppliers.name as amuco_suppliers_name,amuco_contacts.name as amuco_contacts_name');
