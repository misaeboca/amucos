...
<section class="content-header">
    <h1>
        Amuco Suppliers Bank        <small><?= cclang('new', ['Amuco Suppliers Bank']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="beneficiary_wires" id="beneficiary_wires" placeholder="Beneficiary Wires" value="<?= set_value('beneficiary_wires'); ?>">
                                <small class="info help-block">
