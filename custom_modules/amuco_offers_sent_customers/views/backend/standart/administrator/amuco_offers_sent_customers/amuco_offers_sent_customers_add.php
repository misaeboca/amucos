...
<section class="content-header">
    <h1>
        Amuco Offers Sent Customers        <small><?= cclang('new', ['Amuco Offers Sent Customers']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Amuco Offers Sent Customers']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="customer_request_id" id="customer_request_id" placeholder="Customer Request Id" value="<?= set_value('customer_request_id'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="request_details_id" id="request_details_id" placeholder="Request Details Id" value="<?= set_value('request_details_id'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="request_details_price_id" id="request_details_price_id" placeholder="Request Details Price Id" value="<?= set_value('request_details_price_id'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="freight" id="freight" placeholder="Freight" value="<?= set_value('freight'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="unit_price" id="unit_price" placeholder="Unit Price" value="<?= set_value('unit_price'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="option_fcl" id="option_fcl" placeholder="Option Fcl" value="<?= set_value('option_fcl'); ?>">
                                <small class="info help-block">
