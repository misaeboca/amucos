                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/amuco_suppliers/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control capi" onkeyup="javascript:this.value=this.value.toLowerCase()" name="name" id="name" placeholder="Name" value="<?= set_value('name', $amuco_suppliers->name); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="active" id="active" data-placeholder="Select Active" >
                                    <option value=""></option>
                                    <option <?= $amuco_suppliers->active == "0" ? 'selected' :''; ?> value="0">No</option>
                                    <option <?= $amuco_suppliers->active == "1" ? 'selected' :''; ?> value="1">Yes</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            <label for="classification_id" class="col-sm-2 control-label">Classification Id  <i class="required">*</i></label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="classification_id" id="classification_id" data-placeholder="Select Classification Id"  >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('amuco_classification_suppliers') as $row): ?>
                                    <option <?=  ($row->id == $amuco_suppliers->classification_id) ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control capi" onkeyup="javascript:this.value=this.value.toLowerCase()" name="state" id="state" placeholder="State" value="<?= set_value('state', $amuco_suppliers->state); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control capi" onkeyup="javascript:this.value=this.value.toLowerCase()" name="city" id="city" placeholder="City" value="<?= set_value('city', $amuco_suppliers->city); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control capi" onkeyup="javascript:this.value=this.value.toLowerCase()" name="address" id="address" placeholder="Address" value="<?= set_value('address', $amuco_suppliers->address); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="url" id="url" placeholder="Url" value="<?= set_value('url', $amuco_suppliers->url == "" ? 'http://'. $amuco_suppliers->url :  $amuco_suppliers->url); ?>">
                                <small class="info help-block">
