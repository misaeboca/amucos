...
class Amuco_suppliers extends Admin	
{
	...
	public function __construct()
	{
		...
		$this->load->model(['model_amuco_suppliers',
							...
							'amuco_classification_suppliers/model_amuco_classification_suppliers',
							'amuco_suppliers_bank/model_amuco_suppliers_bank'
							]);
	...
	public function add_save()
	{
		...
		if ($this->form_validation->run()) {
			...
			$save_data = [
				...
				'address' =>  ucfirst(strtolower($this->input->post('address'))),
	...
	*/
	...
	public function edit_classification($id){
		...
		if($this->input->post('classification_id_hide') != "" && $id != null){
			$save_data = [
				'classification_id' => implode(',', (array) $this->input->post('classification_id_hide')),
				'date_updated' => date("Y-m-d H:i:s"),
			];
			$save_amuco_suppliers = $this->model_amuco_suppliers->change($id, $save_data);
			if ($save_amuco_suppliers) {
	...
	*/
	public function view($id)
	{
		...
		//var_dump($this->data['supplier_visits']);die;
		$this->data['supplier_contacts'] = $this->model_amuco_contacts->get_contacts($id, 'Supplier','supplier_id');
		$this->data['supplier_classification'] = $this->model_amuco_classification_suppliers->get();
	//var_dump($this->data['supplier_classification']);die;
		$this->data['current_classification'] = []; 
        if(isset($this->data['amuco_suppliers']->classification_id) && trim($this->data['amuco_suppliers']->classification_id) != ""){
			$this->data['current_classification'] = explode(",", $this->data['amuco_suppliers']->classification_id);
		}
		$this->data['amuco_suppliers_bank'] = $this->model_amuco_suppliers_bank->get($id,'supplier_id');
		
		//var_dump($this->data['amuco_suppliers_bank']);die;
		$config = [
