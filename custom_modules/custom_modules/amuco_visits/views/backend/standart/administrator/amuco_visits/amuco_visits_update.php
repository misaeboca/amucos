                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group " id="supplier" style="<?php echo $amuco_visits->type_client== 'Supplier' ? 'display:block':'display:none' ?>">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="date_visit"  placeholder="Date Visit" id="date_visit" value="<?= set_value('date_visit', $amuco_visits->date_visit); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" value="<?= set_value('subject', $amuco_visits->subject); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="notes" name="notes" rows="10" cols="80"> <?= set_value('notes', $amuco_visits->notes); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
