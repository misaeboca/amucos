...
class Model_amuco_products extends MY_Model {
    ...
    public $field_search   = ['id', 'name', 'cas', 'unit_id', 'category_id', 'industry_id'];
    ...
    public function join_avaiable() {
        ...
        $this->db->select('amuco_products.*,amuco_unit_types.name as amuco_unit_types_name,amuco_category_product.name as amuco_category_product_name,amuco_industry_type.name as amuco_industry_type_name,amuco_suppliers.name as amuco_suppliers_name');
