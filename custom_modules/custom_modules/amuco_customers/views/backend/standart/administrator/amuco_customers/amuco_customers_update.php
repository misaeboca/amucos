                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/amuco_customers/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?= set_value('name', $amuco_customers->name); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="active" id="active" data-placeholder="Select Active" >
                                    <option value=""></option>
                                    <option <?= $amuco_customers->active == "0" ? 'selected' :''; ?> value="0">Inactive</option>
                                    <option <?= $amuco_customers->active == "1" ? 'selected' :''; ?> value="1">Active</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="city" id="city" placeholder="City" value="<?= set_value('city', $amuco_customers->city); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="state" id="state" placeholder="State" value="<?= set_value('state', $amuco_customers->state); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="address" id="address" placeholder="Address" value="<?= set_value('address', $amuco_customers->address); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="url" id="url" placeholder="Url" value="<?= set_value('url', $amuco_customers->url); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="is_branche" id="is_branche" data-placeholder="Select Is Branche" >
                                    <option value=""></option>
                                    <option <?= $amuco_customers->is_branche == "0" ? 'selected' :''; ?> value="0">Head office</option>
                                    <option <?= $amuco_customers->is_branche == "1" ? 'selected' :''; ?> value="1">Is  Branche</option>
                                    </select>
                                <small class="info help-block">
                                </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="head_office" id="head_office" placeholder="Head Office" value="<?= set_value('head_office', $amuco_customers->head_office); ?>">
                                <small class="info help-block">
