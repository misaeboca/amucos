                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/amuco_samples/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="note" id="note" placeholder="Note" value="<?= set_value('note', $amuco_samples->note); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="status" id="status" placeholder="Status" value="<?= set_value('status', $amuco_samples->status); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="remarks" id="remarks" placeholder="Remarks" value="<?= set_value('remarks', $amuco_samples->remarks); ?>">
                                <small class="info help-block">
