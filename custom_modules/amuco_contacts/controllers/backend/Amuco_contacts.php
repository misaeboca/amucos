...
class Amuco_contacts extends Admin	
{
	...
	*/
	public function add_save()
	{
		...
		if ($this->form_validation->run()) {
		    $name = ucfirst(strtolower($this->input->post('first_name'))).' '.ucfirst(strtolower($this->input->post('last_name')));
			$save_data = [
				'type_contact' => ucfirst(strtolower($this->input->post('type_contact'))),
				'first_name' => ucfirst(strtolower($this->input->post('first_name'))),
				'last_name' => ucfirst(strtolower($this->input->post('last_name'))),
				'name' => $name,
				'position' => ucfirst(strtolower($this->input->post('position'))),
				'department' => ucfirst(strtolower($this->input->post('departament'))),
				...
				'customer_id' => ucfirst(strtolower($this->input->post('type_contact'))) == 'Customer' ? $this->input->post('customer_id') : null,
				'supplier_id' => ucfirst(strtolower($this->input->post('type_contact'))) == 'Supplier' ? $this->input->post('supplier_id') : null,
				...
				'additional_information' => ucfirst(strtolower($this->input->post('additional_information'))),
	...
	*/
	public function edit($id)
	{
		...
		$this->data['amuco_contacts_referer'] = "";
        if(strpos($_SERVER['HTTP_REFERER'],'amuco_customers/view')){
			$this->data['amuco_contacts_referer'] = "customer_view";
		}
	...
	*/
	public function view($id)
	{
		...
		//var_dump($this->data['amuco_contacts']);die;
	...
	*/
	...
	public function get_data_by_client($id=null){
		$id = $this->input->get('id');
		$search = $this->model_amuco_contacts->get_contacts($id, 'supplier','supplier_id');
		if($search){
			$this->data['success'] = true;
			$this->data['contacts'] = $search;
		}else{
			$this->data['success'] = false;
		}
		echo json_encode($this->data); 
